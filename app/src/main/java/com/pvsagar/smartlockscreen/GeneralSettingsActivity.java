...
public class GeneralSettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        findPreference(PREF_KEY_ENABLE_NOTIFICATION).setOnPreferenceChangeListener(
                new EnableNotificationPreferenceChangeListener(GeneralSettingsActivity.this));

    }

    private static class EnableNotificationPreferenceChangeListener implements Preference.OnPreferenceChangeListener {
        private Context mContext;
        public EnableNotificationPreferenceChangeListener(Context context){
            mContext = context;
        }
...
//            bindPreferenceSummaryToValue(findPreference("example_list"));
            findPreference(PREF_KEY_ENABLE_NOTIFICATION).setOnPreferenceChangeListener(
                    new EnableNotificationPreferenceChangeListener(getActivity()));
        }
    }
